package com.ougong.shop.ActiivtyV2.B_clien.cheng_yun_shang.editInfo
...
import kotlinx.android.synthetic.main.activity_chengyunshang_edit_info.*
import kotlinx.android.synthetic.main.include_setting_back_title.*
import java.io.File

class ChengYunShangEditInfoActivity : BaseActivity<EditInfoContract.View, EditInfoContract.Presenter>(), EditInfoContract.View,
    OnDateSetListener {
...
//        choose_birthdy.text = TimeUtils.DateTimeyyyy_mm_dd(millseconds)
    ...
    override fun setContentViewSource() = R.layout.activity_chengyunshang_edit_info
