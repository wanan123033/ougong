...
class ChoosePlace : BaseActivity<ChoosePlaceContract.view, ChoosePlaceContract.presenter>(), ChoosePlaceContract.view,
    onitemclickLineter {
...
//    private var mSelectProvice: YwpAddressBean.AddressItemBean? = null //选中 省份 bean
//    private var mSelectCity: YwpAddressBean.AddressItemBean? = null//选中 城市  bean
//    private var mSelectDistrict: YwpAddressBean.AddressItemBean? = null//选中 区县  bean
                ...
                1 -> {
                    ...
                    if (bean != null) {
                        if (mSelectProvicePosition != -1) {
                            ...
                            Toast.makeText(this@ChoosePlace, "请您先选择省份", Toast.LENGTH_SHORT).show()
                            return
                        }
                        adapter.notifyDataSetChanged()
                        // 滚动到这个位置
                ...
                2 -> {
                    ...
                    if (bean != null) {
                        if (mSelectCityPosition != -1) {
                            ...
                            Toast.makeText(this@ChoosePlace, "请您先选择城市", Toast.LENGTH_SHORT).show()
                            return
                        }
                        adapter.notifyDataSetChanged()
                        // 滚动到这个位置
