...
public class Banner2 extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.banner_indcater_check;
    private int mIndicatorUnselectedResId = R.drawable.banner_indcater;
    private int mLayoutResId = R.layout.banner2;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        //
//        viewPager.setPageTransformer(true, new Banner2Tranformer());
        initViewPagerScroll();
    }
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.banner_indcater_check);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.banner_indcater);
