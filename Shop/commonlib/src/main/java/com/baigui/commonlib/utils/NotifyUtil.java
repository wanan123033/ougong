...
//                requestCode, intent, FLAG);
     ...
     * @param content
     */
    public void notify_mailbox2(Context context,PendingIntent pendingIntent, int smallIcon, int largeIcon, String largeIcon2, ArrayList<String> messageList,
                                String ticker, String title, String content, boolean sound, boolean vibrate, boolean lights) {
         ...
         **/
        if (!PublicUtils.isBackground(context)) {
            return;
        }
