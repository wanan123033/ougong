package com.baigui.commonview.helper;
...
import com.baigui.commonview.adapter.BaseRecyclerAdapter;
...
//        recyclerView.setPadding(ScreenUtils.dipTopx(context, 16), ScreenUtils.dipTopx(context, 16),
//                ScreenUtils.dipTopx(context, 16), ScreenUtils.dipTopx(context, 16));
