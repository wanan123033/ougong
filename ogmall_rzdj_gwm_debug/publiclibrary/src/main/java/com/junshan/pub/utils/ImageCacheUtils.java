...
public class ImageCacheUtils {
    ...
    public static void loadImage(Context context, String imageUrl, ImageView imageView) {
        ...
        if (imageUrl == null)
            imageUrl = "http://";
        Glide.with(context).load(imageUrl).error(R.drawable.ic_defualt_picture).into(imageView);
    }

    public static void loadImage(Context context, String imageUrl, ImageView imageView, int errorImg) {
        if (imageView == null)
            return;
        if (imageUrl == null)
            imageUrl = "";
        Glide.with(context).load(imageUrl).error(errorImg).into(imageView);
    }
