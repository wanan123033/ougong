package com.ogmall.video.constants;
...
public class PlayParameter {
     ...
     * akId
     */
    public static  String PLAY_PARAM_AK_ID = "LTAILhp2R0DxCgWM";

    /**
     * akSecre
     */
    public static  String PLAY_PARAM_AK_SECRE = "ldzYobvU6y8RH8eNY2H8yUMIbooz4G";
