...
public abstract class BaseRunnable extends com.gwm.android.Runnable {
    ...
    public void sendHandlerMessage(int what,Bundle bundle){
        handler.sendMessage(what, bundle, listener);
    }
    ...
    public void sendHandlerMessageAtTime(int what,int arg1,int arg2,Object obj,long uptimeMillis){
        handler.sendMessageAtTime(what,arg1,arg2,obj,uptimeMillis,listener);
    }
    public void sendHandlerMessageAtTime(int what,Bundle bundle,long uptimeMillis){
        handler.sendMessageAtTime(what,bundle,uptimeMillis,listener);
    }
}
